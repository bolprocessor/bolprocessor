...
//  This an obsolete version of Zouleb() which was used in BP3.5.1 (10 August 2026)
// It has a bug in _rotate as it doesn't handle the field separator ','
// The difference can be observed with the firts items of -da.trySerialTools
// Noneetheless, this version had been used by Harm Visser for -gr.Visser.Waves and -gr.Visser.Shapes
