/*	PrefixReleaseTransWASTE.h

	BP2 MacOS 7-9 Release Target Prefix Header
	
	Based on "Transitional WASTE" target, this target
	links with InterfaceLib and CarbonAccessors.o allowing
	compilation from the Carbon codebase but maintaining
	System 7-compatibility for now.
